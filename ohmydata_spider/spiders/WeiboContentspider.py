...
from ohmydata_spider.util.weiboId import weiboID
from scrapy.selector import Selector
from scrapy.http import Request
from ohmydata_spider.items import WeiboContentItem
import ohmydata_spider.pipelines


class Spider(RedisSpider):
    name = "SinaWeiboContent"
    host = "http://weibo.cn"
    ...
    def getNextID(self, url, cookies):
        ...
        if r.status_code == 200:
            ...
            self.logger.info("Put Id in IDs : %s"%(str(IDs)))
        return IDs